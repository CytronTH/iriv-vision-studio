...
export const nodeTutorials = {
  ...
  dashboardTextNode: {
    title: "Text / Log Feed (Dashboard)",
    description: "โหนดแสดงข้อความแจ้งเตือนบน Live Dashboard",
    input: {
      desc: "รับสถานะจาก Logic Node",
      example: "ต่อสายจาก Logic Node"
    },
    process: {
      desc: "เมื่อมีเหตุการณ์เกิดขึ้นตามเงื่อนไข (True) จะทำการส่งข้อความ (Message) ไปบันทึกเป็นประวัติ (Log) บน Dashboard",
      example: "พิมพ์ข้อความ 'ตรวจพบผู้บุกรุก!' บนหน้าต่าง Log Widget"
    },
    output: {
      desc: "ส่งข้อความไปยังหน้า Dashboard (ฝั่ง UI)",
      example: "N/A"
    }
  },
  debugNode: {
